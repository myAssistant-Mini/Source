...
class Mini:
    ...
    def run_mini(self):
        try:
            ...
            playsound.playsound(
                'marathi_sounds/Mini is Listening.. How Can I help .mp3')
            ...
            for variousTasks in self.taskArray:
                ...
                if variousTasks in task:
                    if variousTasks == 'stop':
                        playsound.playsound(
                            'marathi_sounds/Thank You. Have a nice day..mp3')
                        return 'stop'
            ...
            playsound.playsound(
                "marathi_sounds/Sorry Could not understand.mp3")
        except:
            pass
    ...
    def makeWhatsappMessage(self):
        ...
        playsound.playsound("marathi_sounds/Whom to Send.mp3")
        friend = self.hearYou()

        playsound.playsound("marathi_sounds/What is the message.mp3")
        message = self.hearYou(5)

        hour = datetime.datetime.now().strftime('%H')
        minute = datetime.datetime.now().strftime('%M')

        playsound.playsound("marathi_sounds/Sending message to.mp3")
        self.talk(friend)
        notify.show_toast("MINI - Intelligent Search Engine",
        ...
        if mobile[friend] is None:
            playsound.playsound('marathi_sounds/Sorry No Contact Found.mp3')
            return ''
    ...
    def getWeatherInformation(self):
        ...
        playsound.playsound("marathi_sounds/Which city.mp3")
        city = self.hearYou()
    ...
    Pressure: {pressure} | Humidity: {humidity}''', 'icon.ico', 10, True)
            ...
            self.talk(f'{city}')
            playsound.playsound('marathi_sounds/Weather For City.mp3')

            playsound.playsound('marathi_sounds/Temperature.mp3')
            self.talk(f"{temperature} degree celsius")
            playsound.playsound('marathi_sounds/Weather Report.mp3')
            self.talk(f"{report[0]['description']}")
            playsound.playsound('marathi_sounds/Pressure.mp3')
            self.talk(f"{pressure}")
            playsound.playsound('marathi_sounds/Humidity.mp3')
    ...
    def tellCreatorsInformation(self):
        try:
            playsound.playsound(
                "marathi_sounds/Which creator do you want to know.mp3")
            name = self.hearYou()
            # print(name)
    ...
    def introduceSelf(self):
        playsound.playsound(
            "marathi_sounds/Hello everyone, I am Mini . A intelligent Search Engine and a super useful voice Assistant..mp3")

    def takeASelfie(self):
        playsound.playsound(
            "marathi_sounds/Please Smile, I am taking a Selfie in 2 seconds.mp3")
    ...
    def getAContactNumber(self):
        playsound.playsound(
            "marathi_sounds/Whose Contact number Do You want, Tell his name.mp3")
    ...
    def makeAToDoList(self):
        playsound.playsound(
            "marathi_sounds/Please Say your Name.mp3")
        name = self.hearYou()
        # print(f"Name : {name}")

        playsound.playsound(
            "marathi_sounds/what do you want to note. Please say. I will Note it for you.mp3")
        ...
        playsound.playsound(
            "marathi_sounds/Successfully noted.mp3")
    ...
    def readMyNotes(self):
        ...
        self.talk(name)
        playsound.playsound(
            "marathi_sounds/here is your list.mp3")
    ...
    def inviteForAGoogleMeet(self):
        ...
        playsound.playsound(
            "marathi_sounds/Starting a call and inviting your friends in a minute.mp3")
        url = 'meet.google.com'
        webbrowser.open(url)
        time.sleep(13)
        ...
        playsound.playsound(
            'marathi_sounds/Invitation sent to your colleagues. Do you want to keep your mic and camera on.mp3')
        vid = self.hearYou()
        if vid == 'no':
    ...
    def scrollInstagram(self):
        playsound.playsound(
            'marathi_sounds/Sure, logging you in few seconds.mp3')
        ...
        playsound.playsound(
            "marathi_sounds/What else you wish to do.mp3")
        task = self.hearYou()
    ...
    def sendAnEmail(self):
        playsound.playsound(
            "marathi_sounds/Whom to Send.mp3")
        friend = self.hearYou()
        # print(friend)

        playsound.playsound(
            "marathi_sounds/What is the subject.mp3")
        subject = self.hearYou(5)

        playsound.playsound(
            "marathi_sounds/What is the message.mp3")
        message = self.hearYou(5)
        ...
        playsound.playsound(
            "marathi_sounds/Successfully sent your email.mp3")
    ...
    def readNews(self):
        ...
        for i in range(5):
            ...
            self.talk(Headline)
        playsound.playsound(
            "marathi_sounds/These were the breaking news searched via Mini Search Engine.mp3")

    def readANovel(self):
        notify.show_toast("myAssistant MINI",
                          "Currently Reading: Murder on the Orient Express - Agatha Christie", 'icon.ico', 35, True)
        playsound.playsound(
            'marathi_sounds/Starting to read your favorite book.mp3')
    ...
    def tellTime(self):
        ...
        playsound.playsound(
            'marathi_sounds/Current time is.mp3')
        self.talk(time)
    ...
    def tellDate(self):
        ...
        playsound.playsound(
            "marathi_sounds/Today's Date is.mp3")
    ...
    def startFunZone(self):
        ...
        playsound.playsound(
            'marathi_sounds/You have Entered MINI Fun Zone.mp3')
        while True:
            run = play.fun()
            if run == 'stop':
                break
    ...
    def scroll(self):
        for i in range(10):
            pyautogui.press('down')
        playsound.playsound(
            'marathi_sounds/Do you like this post.mp3')
        like = self.hearYou()
        if 'yes' in like:
            pyautogui.doubleClick(720, 380)
            time.sleep(3)
            playsound.playsound(
                'marathi_sounds/Do you want to keep scrolling.mp3')
            like = self.hearYou()
            if 'yes' in like:
                self.scroll()
            else:
