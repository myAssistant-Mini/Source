...
class Mini:
    ...
    def tellCreatorsInformation(self):
        try:
            ...
            if 'bhavesh' in name:
                ...
                info = rahul.get_info()
                for details in info:
                    self.talk(f"{rahul.get_name()} {details}")
    ...
    def scrollInstagram(self):
        ...
        pyautogui.write('username')  # Add your username
    ...
    def sendAnEmail(self):
        ...
        emails = {"name": 'emailaddress@gmail.com',
